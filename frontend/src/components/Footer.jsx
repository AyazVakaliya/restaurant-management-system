    ...
    <footer className="bg-secondary text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            <h3 className="text-2xl font-bold text-primary mb-4">Royal Palace</h3>
          ...
          <div>
            ...
            <p className="text-gray-400">123 Culinary Ave, Foodie City<br/>Phone: +1 (555) 123-4567<br/>Email: hello@royalpalace.com</p>
          </div>
        </div>
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-500">
          <p>&copy; 2026 Royal Palace Restaurant. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
